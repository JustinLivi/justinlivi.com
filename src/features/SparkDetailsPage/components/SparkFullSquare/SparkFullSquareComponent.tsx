...
import styles from './SparkFullSquareStyles.module.scss';
...
export const SparkFullSquare: React.SFC<SparkFullSquareProps> = ({
  backgroundClass
}) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    xmlnsXlink='http://www.w3.org/1999/xlink'
    viewBox='0 0 133.19 137.27'
  >
    <defs>
      <linearGradient
        id='fsc-linear-gradient'
        x1='54.62'
        y1='55.3'
        x2='65.95'
        y2='55.3'
      ...
      >
        <stop offset='0' stopColor='#e08e26' />
        <stop offset='1' stopColor='#b84a21' />
      </linearGradient>
      <linearGradient
        id='fsc-linear-gradient-2'
        x1='65.66'
        y1='63.49'
        x2='54.99'
        y2='56.06'
        gradientUnits='userSpaceOnUse'
      >
        <stop offset='0' stopColor='#c25823' />
        <stop offset='0.23' stopColor='#bb4d1e' />
        <stop offset='0.65' stopColor='#a82f11' />
        <stop offset='1' stopColor='#941103' />
      </linearGradient>
      <linearGradient
        id='fsc-linear-gradient-3'
        x1='69.04'
        y1='53.38'
        x2='78.54'
        y2='57.72'
        xlinkHref='#fsc-linear-gradient-2'
      />
      <linearGradient
        id='fsc-linear-gradient-4'
        x1='65.38'
        y1='62.95'
        x2='77.43'
        y2='62.65'
        xlinkHref='#fsc-linear-gradient'
      />
      <linearGradient
        id='fsc-linear-gradient-5'
        x1='62.47'
        y1='50.86'
        x2='68.73'
        y2='53.24'
        gradientUnits='userSpaceOnUse'
      >
        <stop offset='0' stopColor='#731001' />
        <stop offset='1' stopColor='#9e1708' />
      </linearGradient>
      <linearGradient
        id='fsc-linear-gradient-6'
        x1='65.75'
        y1='37.25'
        x2='71.09'
        y2='44.93'
        xlinkHref='#fsc-linear-gradient-5'
      />
      <linearGradient
        id='fsc-linear-gradient-7'
        x1='59.43'
        y1='46.27'
        x2='63.36'
        y2='46.27'
    ...
    <g id='Content'>
      <rect
        className={backgroundClass || cx('cls-1')}
        width='133.19'
        height='137.27'
      />
      <polygon
      ...
      <path
        className={cx('cls-12')}
        d='M56.15,44.79a29,29,0,0,0,2.28,3.47L55.34,51.5Z'
      />
      <polygon
        className={cx('cls-13')}
