...
import styles from './BrinkbitFullSquareStyles.module.scss';
...
export const BrinkbitFullSquare: React.SFC<BrinkbitFullSquareProps> = ({
  backgroundClass
}) => (
  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 137.27 137.27'>
    <rect
