...
import styles from './BrinkbitPanelTypographyStyles.module.scss';

const cx = classNames.bind(styles);

export const BrinkbitPanelTypography: React.SFC = () => (
  <Grid item xs={12}>
    <Grid container justify='center' className={cx('fullWidth')}>
      <Grid item xs={8} sm={6} md={4}>
        <div className={cx('container')}>
          <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 127.59 26.74'>
            <path
              className={cx('cls-1')}
