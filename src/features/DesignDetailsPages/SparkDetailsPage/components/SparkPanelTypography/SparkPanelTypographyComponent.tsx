...
import styles from './SparkPanelTypographyStyles.module.scss';

const cx = classNames.bind(styles);

export const SparkPanelTypography: React.SFC = () => (
  <Grid item xs={12}>
    <Grid container justify='center' className={cx('fullWidth')}>
      <Grid item xs={8} sm={6} md={4}>
        <div className={cx('container')}>
          <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 126.3 28.93'>
            <path
              className={cx('cls-1')}
