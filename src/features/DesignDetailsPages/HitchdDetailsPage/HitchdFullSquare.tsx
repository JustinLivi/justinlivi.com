...
import { FilledOrGradientProps, FilledRect, fillOrGradientCss, StopColor } from 'features/SharedComponents/SvgElements';
...
enum LinearGradientIds {
  linearGradient = 'h-linear-gradient',
  linearGradient2 = 'h-linear-gradient-2',
  linearGradient3 = 'h-linear-gradient-3',
  linearGradient4 = 'h-linear-gradient-4',
  linearGradient5 = 'h-linear-gradient-5',
  linearGradient6 = 'h-linear-gradient-6',
  linearGradient7 = 'h-linear-gradient-7',
}

const Path = styled.path<FilledOrGradientProps>`
  ${fillOrGradientCss}
`;

const Rect = styled.rect<FilledOrGradientProps>`
  ${fillOrGradientCss}
`;

export const HitchdFullSquare: React.FunctionComponent<HitchdFullSquareProps> = ({ inverted }) => (
  <svg viewBox="0 0 137.27 137.27">
    ...
    />
    <Path
      useGradient={!inverted}
      fillToken={ColorToken.hitchdSecondary}
